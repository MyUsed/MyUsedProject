...
public class deletePagingAction {
	...
	// 페이징 생성자
	public deletePagingAction(int currentPage, int totalCount, int blockCount,
			int blockPage) {
		...
		if (currentPage > blockPage) {
			pagingHtml.append("<a href=deleteBanner.nhn?currentPage="
					+ (startPage - 1) + ">");
