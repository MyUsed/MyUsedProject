...
public class bankPagingAction {
	...
	// 페이징 생성자
	public bankPagingAction(int currentPage, int totalCount, int blockCount,
			int blockPage) {
		...
		if (currentPage > blockPage) {
			pagingHtml.append("<a href=tradePost.nhn?currentPage="
					+ (startPage - 1) + ">");
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == currentPage) {
				...
				pagingHtml
				.append("&nbsp;<a href='tradePost.nhn?currentPage=");
				pagingHtml.append(i);
				pagingHtml.append("'>");
				pagingHtml.append(i);
				pagingHtml.append("</a>");
