...
public class depositPagingAction {
	...
	// 페이징 생성자
	public depositPagingAction(int currentPage, int totalCount, int blockCount,
			int blockPage) {
		...
		if (currentPage > blockPage) {
			pagingHtml.append("<a href=tradeDeposit.nhn?currentPage="
					+ (startPage - 1) + ">");
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == currentPage) {
				...
				pagingHtml
				.append("&nbsp;<a href='tradeDeposit.nhn?currentPage=");
				pagingHtml.append(i);
				pagingHtml.append("'>");
				pagingHtml.append(i);
				pagingHtml.append("</a>");
