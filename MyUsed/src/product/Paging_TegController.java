...
public class Paging_TegController {
	...
	// 페이징 생성자
	public Paging_TegController(int currentPage, int totalCount, int blockCount,int blockPage, String word) {
			...
			if (currentPage > blockPage) {
				pagingHtml.append("<a href='ProductTegSearch.nhn?currentPage="
						+ (startPage - 1));
				pagingHtml.append("&word=");
				pagingHtml.append(word);
				pagingHtml.append("'>");
			...
			for (int i = startPage; i <= endPage; i++) {
				...
				if (i == currentPage) {
					...
					pagingHtml
							.append("&nbsp;<a href='ProductTegSearch.nhn?currentPage=");
					pagingHtml.append(i);
					pagingHtml.append("&word=");
					pagingHtml.append(word);
					pagingHtml.append("'>");
