...
public class ImageUploadController {
	...
	public String MyUsedUploadPro(MultipartHttpServletRequest request, int mem_num){
		...
		File copy = new File("E:\\Jsp Example\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\MyUsed\\images\\profile\\"+ orgName); // 업로드
	...
	public String MyUsedCoverUploadPro(MultipartHttpServletRequest request, int mem_num){
		...
		File copy = new File("E:\\Jsp Example\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\MyUsed\\images\\cover\\"+ orgName); // 업로드/(데탑)
